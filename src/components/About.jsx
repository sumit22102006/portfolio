        ...
        <section id="about" className="py-20 text-white min-h-screen flex flex-col justify-center">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col gap-16 max-w-6xl mx-auto">
                    ...
                    <motion.div
                        className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-[#111]/50 backdrop-blur-xl border border-white/5 rounded-[2rem] p-8 lg:p-12 hover:border-cyan-500/30 transition-all duration-500 shadow-2xl"
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="space-y-4 text-gray-300 leading-relaxed text-lg">
                                {aboutBio.split('\n\n').map((paragraph, index) => (
                                    <p key={index} className="first-letter:text-2xl first-letter:font-bold first-letter:text-cyan-400 first-letter:mr-1">
                                        {paragraph}
                                    </p>
                                ))}
                            </div>
