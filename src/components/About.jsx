            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-center">
                        About <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-violet-500">Me</span>
                    </h2>
                ...
                <div className="flex flex-col gap-16 max-w-4xl mx-auto">
                    ...
                    {/* Bio Section */}
                    <motion.div
                        className="bg-[#0a0a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 hover:border-cyan-500/30 transition-colors duration-300 shadow-xl shadow-black/50"
