            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-center">
                        My <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-500">Projects</span>
                    </h2>
                                ...
                                <div className="flex flex-wrap items-center gap-3 mt-auto">
                                    ...
                                    {project.liveDemo !== '#' && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex-1 min-w-[100px] flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-cyan-400 to-blue-600 hover:from-cyan-300 hover:to-blue-500 text-black font-bold shadow-lg shadow-cyan-500/25 border border-transparent transition-all text-xs sm:text-sm font-medium"
